...
### [2] [Leveraging Population Dynamics to Steer Efficient Search in Large-Scale Combinatorial Optimization](https://arxiv.org/abs/2606.25203)
...
### [3] [A Scalable Time-Based Molecular Dynamics Approach for Simulating Single-Bubble Sonoluminesce](https://arxiv.org/abs/2606.25219)
...
### [4] [A Neural Surrogate Approach for Simulating Natural Convection Problems](https://arxiv.org/abs/2606.25259)
...
### [5] [A convolutional neural network surrogate for hierarchical homogenization: fast elastic moduli prediction of digital rocks](https://arxiv.org/abs/2606.25275)
...
### [6] [Monte Carlo physics-informed neural networks for inverse multiscale heat conduction problems via the phonon Boltzmann transport equation](https://arxiv.org/abs/2606.25793)
...
### [7] [A one-parameter family of realizability-interior closures for odd-order kinetic moment systems](https://arxiv.org/abs/2606.26032)
*Somdeb Bandopadhyay*
...
### [8] [Machine learning is revolutionizing weather forecasting -- the next step is a change in how we work](https://arxiv.org/abs/2606.25076)
...
### [9] [Evaluation of medium range machine learning models for sub-seasonal prediction](https://arxiv.org/abs/2606.25417)
...
### [10] [Event-Aware Loss Design for Forecasting of Convective Precipitation and Lightning](https://arxiv.org/abs/2606.25937)
...
### [11] [Minimax PAC Bounds for Learning in Exogenous Contextual MDPs](https://arxiv.org/abs/2606.25170)
...
### [12] [Stabilizing black-box algorithms through task-oriented randomization](https://arxiv.org/abs/2606.25269)
...
### [13] [Statistically Valid Hyperparameter Selection: From Tuning to Guarantees](https://arxiv.org/abs/2606.25601)
...
### [14] [Gaussian Mean Field Variational Inference can Overestimate Predictive Variance](https://arxiv.org/abs/2606.25745)
...
### [15] [FedReLa: Imbalanced Federated Learning via Re-Labeling](https://arxiv.org/abs/2606.26037)
...
### [16] [When Does Synthetic Data Augmentation Improve Score-Based Imbalanced Classification?](https://arxiv.org/abs/2606.26053)
