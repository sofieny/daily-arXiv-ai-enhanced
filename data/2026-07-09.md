...
### [10] [Geometric Collapse: When Vision Models Fail to Verify Physical Causality](https://arxiv.org/abs/2607.06871)
...
### [11] [Video2Reaction: Mapping Video to Audience Reaction Distribution in the Wild](https://arxiv.org/abs/2607.06875)
...
### [13] [Smart Scissor: Coupling Spatial Redundancy Reduction and CNN Compression for Embedded Hardware](https://arxiv.org/abs/2607.06915)
...
### [15] [SpiS-GAN: Spiral-Modulated Handwriting Synthesis with Star Operation](https://arxiv.org/abs/2607.06949)
...
### [18] [SHTA: Semantic Hard Token Correction and Center Alignment for Semi-Supervised Medical Image Segmentation](https://arxiv.org/abs/2607.07019)
...
### [20] [Tree-of-Thoughts Reasoning for Text-to-Image In-Context Learning](https://arxiv.org/abs/2607.07117)
...
### [22] [ASFR-Net: Adversarial Alignment and Spatio-Frequency Refinement Network for Heterogeneous Remote Sensing Image Change Detection](https://arxiv.org/abs/2607.07161)
...
### [23] [TACoS: Weakly Supervised Learning of Two-Dimensional Materials from Scribble Annotations to Precise Segmentation](https://arxiv.org/abs/2607.07169)
...
### [24] [Prototype-Anchored Generalized Manifold Regression for Unknown-Domain Object Detection](https://arxiv.org/abs/2607.07192)
...
### [26] [Why Fake ? Unveiling the Semantic Vocabulary of Deepfake Detectors](https://arxiv.org/abs/2607.07216)
...
### [27] [MMAgent-R$^2$: Learning to Rerank and Reject for Agentic mRAG](https://arxiv.org/abs/2607.07383)
...
### [28] [A Theory of Contrastive Learning with Natural Images](https://arxiv.org/abs/2607.07470)
...
### [30] [Automatic Echocardiography Segmentation via Transition Probability Correlation for Stable Semantic Extraction](https://arxiv.org/abs/2607.07580)
...
### [31] [Cardiac MRI Through-Plane Super-Resolution Guided by Reference and Memory](https://arxiv.org/abs/2607.07581)
...
### [32] [MedPMC: A Systematic Framework for Scaling High-Fidelity Medical Multimodal Data for Foundation Models](https://arxiv.org/abs/2607.07673)
...
### [33] [Healthier LLMs: Retrieval-Augmented Generation for Public Health Question Answering](https://arxiv.org/abs/2607.06641)
...
### [34] [Gradient-Based Speech-to-Text Alignment for Any ASR Model: From CTC to Speech LLMs](https://arxiv.org/abs/2607.06831)
...
### [35] [MILES: Modular Instruction Memory with Learnable Selection for Self-Improving LLM Reasoning](https://arxiv.org/abs/2607.06974)
...
### [37] [Evaluating RAG Metrics in Applied Contexts: An Experiment, Its Findings and Its Limitations](https://arxiv.org/abs/2607.07302)
*Quentin Brabant*
...
### [38] [DeLS-Spec: Decoupled Long-Short Contexts for Parallel Speculative Drafting](https://arxiv.org/abs/2607.07409)
...
### [39] [DiaLLM: An Investigation into the Robustness-Generation Gap in English Dialect Adaptation](https://arxiv.org/abs/2607.07669)
...
### [41] [A Note on the Orthogonalization of Real-valued Trigonometrical Basis Functions](https://arxiv.org/abs/2607.06571)
*R. J. Cintra*
...
### [42] [A Multi-Analyst LLM Pipeline for Auditable Rule Discovery Across 68 Public Physiological Corpora](https://arxiv.org/abs/2607.06802)
*Dovy Paukstys*
...
### [43] [Spatial Limits of Fluid Antenna Systems](https://arxiv.org/abs/2607.07333)
...
### [44] [Dual-Mapping Sparse Vector Coding for Phase Noise-Resilient Short-Packet Transmission](https://arxiv.org/abs/2607.07454)
...
### [45] [AgentLens: Production-Assessed Trajectory Reviews for Coding Agent Evaluation](https://arxiv.org/abs/2607.06624)
...
### [46] [LLM-powered reasoning in agent-based modeling](https://arxiv.org/abs/2607.06757)
...
### [47] [Learning social norms enhances compatibility in dynamic human-AI coordination](https://arxiv.org/abs/2607.07021)
...
### [48] [Measuring Intelligence Beyond Human Scale](https://arxiv.org/abs/2607.07040)
...
### [49] [Operational Reframing and Approval-Framed Delegation in Multi-Agent LLM Safety](https://arxiv.org/abs/2607.07097)
...
### [51] [RL Post-Training Builds Compositional Reasoning Strategies](https://arxiv.org/abs/2607.07646)
...
### [52] [Recursive Self-Improvement in AI: From Bounded Self-Refinement to Autonomous Research Loops](https://arxiv.org/abs/2607.07663)
...
### [53] [Institutional Red-Teaming: Deployment Rules, Not Just Models, Causally Shape Multi-Agent AI Safety](https://arxiv.org/abs/2607.07695)
*Yujiao Chen*
...
### [54] [Value of Information under Imprecise Probabilities: Decision-Rule-Specific Values and Fixed-Measure Envelopes on a Credal Set](https://arxiv.org/abs/2607.06570)
*Rowan Iskandar*
...
### [55] [Fast determinantal sampling on general spaces and diffusion geometry](https://arxiv.org/abs/2607.06644)
...
### [56] [Tensor Train Diffusion: Leveraging Low-Rank Structures for High-Dimensional Score-Based Sampling](https://arxiv.org/abs/2607.06841)
...
### [57] [Finding a stationary point of a stochastic convex problem](https://arxiv.org/abs/2607.06883)
...
### [58] [Tensorized algorithms and scalable filtering methods for hidden Markov and factorial hidden Markov models](https://arxiv.org/abs/2607.07008)
...
### [59] [Statistical inverse learning and $\ell^1$-regularization](https://arxiv.org/abs/2607.07468)
...
### [60] [Impact of Courant number on the results of numerical simulating of signal propagation in non-dispersive homogeneous media](https://arxiv.org/abs/2607.06707)
...
### [61] [Radiation Damage Cascades in Fullerite Using Molecular Dynamics](https://arxiv.org/abs/2607.06962)
...
### [62] [Inverse Low-Dimensional Manifold Reconstruction Framework for Spatiotemporal Reconstruction of Compressible Physical Fields](https://arxiv.org/abs/2607.07084)
...
### [63] [Collaborate to decorrelate in path space: Hamiltonian replica exchange transition interface sampling (HRETIS)](https://arxiv.org/abs/2607.07453)
...
### [64] [Semilocal exchange functionals from the exact-exchange condition for the hydrogen atom: Hydrogenic exactness and recovery of Rydberg-like bound states](https://arxiv.org/abs/2607.07648)
*Fumihiro Imoto*
