...
### [2] [A Picture Says Thousands of Words - Harnessing Dermal Exposure Data from Images through Hybrid Deep Learning for Enhanced Safety Assessment](https://arxiv.org/abs/2607.26170)
...
### [8] [Spline-Based Boundary Representations for Sparse View Reconstruction and Simulation Using Isogeometric Analysis](https://arxiv.org/abs/2607.26234)
...
### [9] [LumaGuide: Distribution Shaping for Training-Free HDR Generation in Diffusion Models](https://arxiv.org/abs/2607.26237)
...
### [10] [Lightweight Image Classification of Raptor Species for Edge Devices: Rare-Species Dataset Expansion via Video Frame Extraction, Knowledge Distillation, and TensorRT Deployment](https://arxiv.org/abs/2607.26238)
*Takeshi Nishikawa*
...
### [11] [Comparing the Performance of Foundation Model Derived Embeddings with Traditional Approaches for Distant Metastasis Prediction in Head and Neck Cancer](https://arxiv.org/abs/2607.26276)
...
### [12] [HeteroPROPMT: A Real-time and Privacy-Preserving Heterogeneous Collaborative Perception Framework](https://arxiv.org/abs/2607.26283)
...
### [13] [Eddeep: a deep-learning framework for fast eddy-current distortion correction in diffusion MRI](https://arxiv.org/abs/2607.26292)
...
### [14] [MoSAIC: Aligned Intervention Supervision for Part-Local Motion Style Transfer](https://arxiv.org/abs/2607.26304)
...
### [15] [Seeing or Knowing? Visual Context Sensitivity in Multimodal Large Language Models](https://arxiv.org/abs/2607.26326)
...
### [16] [Zero-Fi: Zero-Shot Wi-Fi-Based Human Activity Recognition via Contrastive Signal-Language Alignment](https://arxiv.org/abs/2607.26381)
...
### [17] [Registration-Grounded Spectral Fusion for Unregistered WLI/NBI Endoscopic Lesion Segmentation](https://arxiv.org/abs/2607.26395)
...
### [18] [Do Unified Multimodal Models Think in One Space? A Lens Through Cross-Branch Steering](https://arxiv.org/abs/2607.26411)
*Yu Wang,Sharon Li*
...
### [19] [When Fish Look Alike: Tracking Identities with Dual-branch Elasticity](https://arxiv.org/abs/2607.26412)
...
### [20] [FAS-R1: A Unified Multi-Task MLLM for Reasoning Face Anti-Spoofing](https://arxiv.org/abs/2607.26432)
...
### [21] [Interpretable Image-Level Acne Severity Grading via EfficientNet-B0 Transfer Learning and Grad-CAM](https://arxiv.org/abs/2607.26461)
...
### [22] [HERMES: A Hybrid Ensemble for Head-and-Neck Tumor Segmentation, TN Staging, and Recurrence-Free Survival on PET/CT](https://arxiv.org/abs/2607.26498)
...
### [23] [Semantic-Aware Temporal Adaptation for UAV Anti-UAV Tracking](https://arxiv.org/abs/2607.26511)
...
### [25] [CineWeaver: Training-Free Reference-Controllable Multi-Shot Long Video Generation for Cinematic Storytelling](https://arxiv.org/abs/2607.26529)
...
### [26] [TPCD: Tone-Pressure Contrastive Decoding and the Label-Free Gating Bottleneck in Vision-Language Models](https://arxiv.org/abs/2607.26536)
...
### [27] [From Spatial Semantics to Temporal Context: Leveraging Gaze Trajectory for Weakly Supervised Medical Image Segmentation](https://arxiv.org/abs/2607.26542)
...
### [28] [MedARC: Training-Free Adaptive Redundancy Compression of Visual Tokens for 3D Medical Vision-Language Models](https://arxiv.org/abs/2607.26554)
...
### [29] [Representation Trajectories Matters: Complementary Evidence for OOD Detection and Image Classification](https://arxiv.org/abs/2607.26565)
...
### [30] [3DGBGS: 3D Granular Ball Gaussian Splatting for Compact Novel View Synthesis](https://arxiv.org/abs/2607.26578)
...
### [31] [Forensic Reproducibility Audit of a Radiology Vision-Language Model Benchmark: From Intended Protocol to Released Artifact](https://arxiv.org/abs/2607.25589)
*Mateusz Kozłowski*
...
### [35] [Weight and Height Estimation from a Single Human Image Captured in the Wild](https://arxiv.org/abs/2607.26104)
...
### [36] [SpatialQ: Understanding 3D Gaussian Splatting Scene Quality via Visual-based MLLM](https://arxiv.org/abs/2607.26595)
...
### [37] [Decoupled Visual Processing: Efficient Multimodal Adaptation via Modality-Specific Transformer Substitution](https://arxiv.org/abs/2607.26596)
...
### [38] [JEPADepth: Masked Predictive Representation Learning for Self-Supervised Monocular Depth Estimation](https://arxiv.org/abs/2607.26600)
...
### [39] [Understanding Knowledge Transfer Mechanism in Heterogeneous MLLM Fusion: A Simple Linear Approach](https://arxiv.org/abs/2607.26608)
...
### [40] [FakeIDet3-DB: Refining Digital Attacks and Patch Extraction for Secure ID Benchmarking](https://arxiv.org/abs/2607.26641)
...
### [41] [FPSGen: Flexible Point Cloud Scene Generation with BEV-Supported Transport Flows](https://arxiv.org/abs/2607.26645)
...
### [42] [Genie Sim PanoWorld: An Infinite Indoor 3D World Generation Pipeline via Panoramic Scene Modeling and Simulation](https://arxiv.org/abs/2607.26646)
...
### [43] [Anchoring and Steering Diffusion: Enhancing the Faithfulness of Text-to-Image Generation at Inference Time](https://arxiv.org/abs/2607.26647)
...
### [45] [Visko Orbis 1.0: A Live Model for Real-Time Interactive Long Video Generation](https://arxiv.org/abs/2607.26694)
...
### [46] [Sequence-SOD: Bio-inspired Sequence-aware Spiking ObjectDetection for Event Cameras](https://arxiv.org/abs/2607.26703)
...
### [47] [TPD: Temporal Prior Decoupling for Text-to-Video Diffusion Models](https://arxiv.org/abs/2607.26706)
...
### [48] [FreeShadow: Training-Free Shadow Removal via Illumination Transfer and Selective Content Preservation in Diffusion Models](https://arxiv.org/abs/2607.26715)
...
### [49] [CASIAL: Geometric Distortion Robust Image Watermarking](https://arxiv.org/abs/2607.26729)
...
### [50] [Online Handwriting Trajectory Reconstruction from Kinematic Sensors using Temporal Convolutional Network](https://arxiv.org/abs/2607.26733)
...
### [51] [Dual Inversion for Text-to-Image Diffusion Models: From Both Prompt and Noise Perspectives](https://arxiv.org/abs/2607.26735)
...
### [53] [StatePlay: State-Aware Game World Models for Mechanics-Consistent Generation](https://arxiv.org/abs/2607.26754)
...
### [64] [CinemaTraj: Composing Atomic Camera Trajectories for 3D Scenes with LLM Agents](https://arxiv.org/abs/2607.26910)
...
### [71] [Robust RPC Bundle Adjustment for Multi-Date Satellite Imagery with Season-Invariant Correspondences](https://arxiv.org/abs/2607.26973)
...
### [82] [HumanCLAW: Can Vision-Language Models Act Through a Body?](https://arxiv.org/abs/2607.27180)
...
### [83] [VidMap: Exploiting Temporal Structure for Video-Based Structure-from-Motion](https://arxiv.org/abs/2607.27194)
...
### [84] [TurboVLA: Real-Time Vision-Language-Action Model at 32 Hz on an RTX 4090 with <1 GB VRAM](https://arxiv.org/abs/2607.27205)
...
### [85] [Characterizing Human-Likeness in AI Generated Poetry: A Zero-shot Classification Study](https://arxiv.org/abs/2607.26221)
...
### [86] [Steering Instruction Hierarchies at Inference Time](https://arxiv.org/abs/2607.26228)
...
### [87] [A large-scale corpus of religious radio broadcast transcripts from webstream recordings in the United States](https://arxiv.org/abs/2607.26249)
...
### [88] [Robostreet Flow: A Lightweight, Ultra-Low-Drag Electric Tractor and Four-Truck Hybrid Convoy Architecture for Minimum-Cost Point-to-Point Freight](https://arxiv.org/abs/2607.26250)
...
### [89] [Evaluating Prompt Scope and Demonstration Similarity in Local LLM Machine Translation](https://arxiv.org/abs/2607.26286)
*Mihael Arcan*
...
### [90] [AgentGUI: An Interface for Observing and Steering Long-Running AI Agents](https://arxiv.org/abs/2607.26300)
...
### [91] [When Synthetic Users Fail: A Cross-Domain Benchmark of LLM-Simulated Human Survey Responses](https://arxiv.org/abs/2607.26348)
...
### [92] [Symphony of Bias: Exploring Gender Associations with Musical Instruments in Multimodal LLMs](https://arxiv.org/abs/2607.26355)
...
### [93] [Diagnosing Fine-Grained Inconsistency Classification in Financial Disclosure Text](https://arxiv.org/abs/2607.26368)
...
### [94] [(Im)Paired Programming: Coding Agents Improve Productivity but Harm Understanding](https://arxiv.org/abs/2607.26375)
...
### [95] [Misalignment Has a Personality: A Big Five Account of Emergent Misalignment](https://arxiv.org/abs/2607.26389)
...
### [96] [Phoneme- vs. Character-Level Targets and Selective State-Space Models for Intracortical Brain-to-Text](https://arxiv.org/abs/2607.26751)
...
### [111] [Metis: Memory Foundation Model](https://arxiv.org/abs/2607.26760)
...
### [112] [Relation Geometry in Semantic Space of Language Models](https://arxiv.org/abs/2607.26762)
...
### [113] [Enhancing Generative Information Extraction with Two-step Validation: A Product Attribute Use Case](https://arxiv.org/abs/2607.26780)
...
### [114] [When Does Span-Guided Detoxification Help? Human Preferences and Evaluator Diagnostics in a Controlled Comparison](https://arxiv.org/abs/2607.26795)
*Kyungwon Park*
...
### [115] [Large-Scale ChatBot Validation Through Customer Digital Twin Simulations](https://arxiv.org/abs/2607.26060)
...
### [117] [Do Methods Support the Claims? Intra-Paper Verification for Peer Review](https://arxiv.org/abs/2607.26066)
...
### [118] [Language Models are not Equally Robust to Non-Canonical Tokenization across Languages](https://arxiv.org/abs/2607.26831)
...
### [119] [From Representations to Behaviors: Exploring the Person-Situation-Behavior Triad in LLMs](https://arxiv.org/abs/2607.26853)
...
### [121] [DIRECT: Direct Decoding for Efficient and Aligned Sequence Labeling with Large Language Models](https://arxiv.org/abs/2607.26891)
...
### [122] [Dual-Path LLM Reasoning for Multimodal Few-Shot Knowledge Graph Completion](https://arxiv.org/abs/2607.26909)
...
### [123] [Latent-IM: Latent Interaction Management for Speech LLMs](https://arxiv.org/abs/2607.26928)
...
### [124] [Same Evidence, Different Target: Decoding How Diagnostic Evidence Bears on Causal Questions from Language-Model States](https://arxiv.org/abs/2607.26929)
...
### [125] [Credit Cards, Confusion, Computation, and Consequences: What Can We Uncover About Language Model Reasoning?](https://arxiv.org/abs/2607.26952)
...
### [126] [Generation or Judgement? A Paradigm Perspective on LLM-Based Emotion-Cause Pair Extraction in Conversation](https://arxiv.org/abs/2607.26967)
...
### [127] [TREK: A Travel Reasoning and Evaluation Kit for LLM Agents in Complex Trip Planning](https://arxiv.org/abs/2607.26977)
...
### [128] [OptimismBench: Forecasting Bias and the Alignment Effect in Language Model Judgment](https://arxiv.org/abs/2607.26981)
...
### [129] [Evaluating Regional Bias in LLMs From Abstract Stereotype to Concrete Social Decision-Making](https://arxiv.org/abs/2607.27022)
...
### [130] [DenseOn with the LateOn: Fully Open Dense and Late-Interaction Models for Multilingual, Long-Context, and Code Search](https://arxiv.org/abs/2607.27178)
...
### [131] [Pangram 4 Technical Report](https://arxiv.org/abs/2607.27183)
...
### [132] [APEX-Accounting](https://arxiv.org/abs/2607.27189)
...
### [133] [Mental World Modeling](https://arxiv.org/abs/2607.27201)
*Hao Fei,Yiran Zhao*
...
### [134] [Crossing-Free Probabilistic K-Line Forecasts Without Retraining](https://arxiv.org/abs/2607.26792)
...
### [135] [Think Short, Defer Smart, Act, and Repeat: Calibrated Reasoning and Uncertainty-Aware Deferral for Edge LLM Agents](https://arxiv.org/abs/2607.26865)
...
### [136] [Conformalized Rate-Adaptive Sensing](https://arxiv.org/abs/2607.26887)
...
### [137] [Breaking the Curse with BAND: Nonparametric Distribution Estimation in High Dimensions](https://arxiv.org/abs/2607.26955)
...
### [138] [Feature Bagging Provides Stability](https://arxiv.org/abs/2607.26964)
*Yuheng Ma,Qiang Sun*
...
### [139] [PIKS: Universal Physics-Informed Kernel Methods](https://arxiv.org/abs/2607.27062)
...
### [140] [Even More Deception: Objective Misalignment in Mixed-Motive LLM Multi-Agent Systems](https://arxiv.org/abs/2607.26120)
...
### [170] [MVLA-GR: A Phase-Free Multipath-Based Geometry Reconstruction Method via Multi-View Likelihood Accumulation for ISAC](https://arxiv.org/abs/2607.26421)
...
### [171] [Calibrating the Digital Twin Channel: Statistics-Consistent Sim-to-Lab Adaptation for W-Band Industrial OFDM Links](https://arxiv.org/abs/2607.26501)
...
### [172] [A Data-Driven Vibration Analysis Framework for Micro-Motor Fault Diagnosis and Quality Control](https://arxiv.org/abs/2607.26519)
...
### [173] [Secure Relay Low-Altitude Networks via Hybrid Fixed-Position and Rotatable Antenna Arrays](https://arxiv.org/abs/2607.26531)
...
### [174] [Stay or Switch: Online Conformal Bayesian Optimization Guided Fluid Antenna Configuration](https://arxiv.org/abs/2607.26547)
...
### [175] [Multi-User Localization via Active Sensing with Electromagnetically Reconfigurable Antennas](https://arxiv.org/abs/2607.26605)
...
### [176] [An Informativeness-based Clustered Federated Learning Method for Reliable Traffic Prediction in Managed Wi-Fi Networks](https://arxiv.org/abs/2607.26682)
...
### [177] [A Dual-Mode FM/AM Modulator Based on a Time-Varying Inverting Integrator](https://arxiv.org/abs/2607.26738)
...
### [178] [Efficient Channel Prediction based on Gram-Square-Root Factorization using GMMs](https://arxiv.org/abs/2607.26959)
...
### [179] [Probabilistic Denoising-Enhanced ISAC for Stochastic Cluttered Mobile Environments](https://arxiv.org/abs/2607.26994)
...
### [180] [Two-Filter Adaptive Gaussian Mixture Smoothing for Nonlinear Systems](https://arxiv.org/abs/2607.27151)
